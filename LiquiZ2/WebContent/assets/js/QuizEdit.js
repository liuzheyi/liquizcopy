...
QuizEdit.prototype.deleteAnswer = function (i) {
...
QuizEdit.prototype.addSurveyQuestion = function (i) {
	...
	c = tr.insertCell();
	c.appendChild(this.editButton("delete", this.deleteSurveyQuestion));
}
...
QuizEdit.prototype.editSurvey = function () {
	...
	var surveyQuestions = [];
	for (var i = 0; i < 4; i++) {
		surveyQuestions.push([Util.input("text", QuizEdit.QUESTION, 'surveyQuestion' + i), this.editButton("delete",  this.deleteSurveyQuestion)]);
	} 
...
QuizEdit.prototype.deleteRegex = function () {
	...
	QuizEdit.regex.deleteRegex(name);
...
QuizEdit.prototype.editQuestion = function () {
    ...
    [
      this.editButton("ImgClick", this.editImage),
